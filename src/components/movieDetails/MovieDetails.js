...
function MovieDetails() {
  ...
  /*const searchQuery = location.search ? new URLSearchParams(location.search).get('query') : null;
...
function MovieDetails() {
  ...
  // Отримання значення квері параметра "query" з URL
  ...
  const handleGoBack = () => {
    // Перевірка наявності квері параметра і відповідне відправлення назад на пошукову сторінку або на головну сторінку
    if (searchQuery) {
